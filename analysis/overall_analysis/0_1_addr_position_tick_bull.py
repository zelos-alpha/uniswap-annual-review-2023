...
folder_path = '/home/zelos/src/UGPCA/result/csv' 
save_path = '/home/zelos/src/UGPCA/result/csv/02_init'
...
for name in tqdm(address_list, desc='Processing Files2'):
    ...
    save_path_price = os.path.join(save_path,"price_result_bull")
    if not os.path.exists(save_path_price):
        os.makedirs(save_path_price)
    path_result = os.path.join(save_path+"/price_result_bull", name + '.csv')
