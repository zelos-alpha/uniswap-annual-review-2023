...
position_data_path = '/home/zelos/src/UGPCA/result/csv/02_init/price_result_bull'
pos_cal_path = '/home/zelos/src/UGPCA/result/csv/pos_analysis_bull'
if not os.path.exists(pos_cal_path):
    os.makedirs(pos_cal_path)
file_list = os.listdir(pos_cal_path)
for file_name in file_list:
    file_path = os.path.join(pos_cal_path, file_name)
    os.remove(file_path)
...
bull_df =  pd.read_csv("/home/zelos/src/UGPCA/result/csv/alpha/year_address_alpha_beta_ethereum_total.csv")
# address,alpha,beta
# 0x4d42f1caad35f0302e24e8477e584e2ae64027e9,21.631141983092924,0.9668757895252383
# 0x4dae4864681dea2c5b8cf9b29a9ef55b28e29fc0,14.443563528104818,0.5890726971964723
filtered_df = bull_df[bull_df['alpha'] > 0]
address_list = filtered_df['address'].tolist()
