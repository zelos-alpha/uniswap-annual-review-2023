...
import datetime
import numpy as np
folder_path = '/home/zelos/src/UGPCA/result/csv/pos_analysis'
...
plt.title('Probability Density of Holding Time in Bear/Bull Markets')
plt.legend()

plt.savefig('/home/zelos/src/UGPCA/result/plot/Probability Density of holding_time in BearBull Markets.png')