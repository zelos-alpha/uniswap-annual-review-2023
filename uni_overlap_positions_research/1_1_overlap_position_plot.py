...
total_market_df = pd.read_csv('/home/zelos/src/uni_pos_research/result/csv/overlap_periods.csv')

total_market_df = total_market_df[total_market_df['persentage %'] >= 0]
...
plt.title('Density of Overlap Position Percentage Distribution on ETH')
